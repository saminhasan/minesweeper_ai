...
os.environ["pg_HIDE_SUPPORT_PROMPT"] = "1"
import sys
import random
import asyncio
import numpy as np
...
class GUI:
    ...
    async def run(self) -> None:
        """
        Main game loop for handling updates and events.
        """
        try:
            while self.running:
...
if __name__ == "__main__":
    # Create an instance of the GUI with the desired difficulty level
    game: GUI = GUI("easy")  # 'easy', 'intermediate', or 'hard'
